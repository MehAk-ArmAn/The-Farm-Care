...
<head>
    ...
    <title>Create Category | The Farm Care</title>
...
<body class="bg-gray-50 min-h-screen p-6">
    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-slate-900">Add New Category</h1>
                <p class="mt-1 text-sm text-slate-600">Create a clean category structure for products.</p>
            </div>
