...
@section('content')
<section class="relative overflow-hidden bg-slate-950 pt-32 text-white md:pt-36">
                ...
                @foreach($products as $product)
                    <article class="group overflow-hidden rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200 transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                        ...
                        <p class="mt-3 min-h-[84px] text-sm leading-7 text-slate-600">
                            {{ $product->short_description ?: 'Premium product presentation ready for inquiries, distributor discussions, and direct buyer engagement.' }}
                        </p>
